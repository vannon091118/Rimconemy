...
> **Status:** `COMPILED`
> **Code-Anker:** `Source/World/WorldRaidCoordinator.cs` · **Test:** `Tests/WorldRaidRegressionTests.cs`
...
- Kompiliert: ✅
- Bootstrap-Klasse: `Infected.Bootstrap.RunAll` ruft `Tests/WorldRaidRegressionTests.cs` auf
- Patch-Klassen: `mods/infected/Source/Infected/*.cs`

## C — Selbsttest (RunAll)

`Tests.AutoResolveRegressionTests.RunAll()` ist in `Bootstrap` aufgerufen.
