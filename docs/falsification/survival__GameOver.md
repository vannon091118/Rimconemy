...
> **Status:** `COMPILED`
> **Code-Anker:** `Source/GameOver/GameOverDetector.cs` · **Test:** `Tests/GameOverDetectionRegressionTests.cs`
...
- Kompiliert: ✅
- Bootstrap-Klasse: `Survival.Bootstrap.RunAll` ruft `Tests/GameOverDetectionRegressionTests.cs` auf
- Patch-Klassen: `mods/survival/Source/Survival/*.cs`

## C — Selbsttest (RunAll)

`Tests.GameOverRegressionTests.RunAll()` ist in `Bootstrap` aufgerufen.
