...
| Storyteller Design Decisions | [docs/STORYTELLER_DESIGN_DECISIONS.md](STORYTELLER_DESIGN_DECISIONS.md) | Mod 05 | 4 Fragen geklärt: DLC-Incidents ersetzen, Difficulty behalten, Clean Break (keine Migration), Mod-Kompatibilität per Akzeptanz |
