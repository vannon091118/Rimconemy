...
- **H:** ✅ DECISIONS-Drift H1–H6 abgeglichen (Audit 2026-08-04, Stand 09:27):
  ...
  | §6 Wallet/Trade | Credits = Wallet, Silber = physisches Upgrade-Material, separates Trade-Panel | `CreditsLedger`: pure Wallet (`CurrencyId="credits"`, `MaxBalance=1e9`, Transactions, Idempotenz-Map, Scribe) ✅; `TradePanel.cs` zeigt Credits-Balance/Einnahmen/Ausgaben/Historie ✅; **Silber als Upgrade-Material ⬜** (`Source/Upgrades/SilverMaterial.cs` entfernt 2026-08-05 — widersprach der Credits-Entscheidung „never silver", kein Caller; siehe `docs/falsification/deadcode-audit-2026-08-05.md`); **Upgrade-Panel mit Silber-Kosten ⬜** (Phase-6, getrackt in §8.6) | ⚠ Credits ✅, Silber/Upgrade-Panel ⬜ |
